...
#define CLK_5110 GPIO_Pin_0    //PB
#define DC_5110 GPIO_Pin_2     //pb
#define CE_5110 GPIO_Pin_11    //pb
#define RST_5110 GPIO_Pin_12    //pb
#define DIN_5110 GPIO_Pin_1   //pb
...
void setup_nokia(void){
	...
	/*Configure GPIO pin */
	GPIO_InitStruct.GPIO_Pin = GPIO_Pin_11|GPIO_Pin_12|GPIO_Pin_0|GPIO_Pin_1|GPIO_Pin_2;
...
void NOKIA5110_WriteData(uint8_t Data)
{
	uint8_t i;
	//NOKIA5110_DC=1;
	GPIO_SetBits(GPIOB,DC_5110);
	for(i=0;i<8;i++)
   {
      if(Data&(0x80>>i))
			GPIO_SetBits(GPIOB,DIN_5110);
      else
			GPIO_ResetBits(GPIOB,DIN_5110);
			GPIO_SetBits(GPIOB,CLK_5110);
			delay_ms(1);
			GPIO_ResetBits(GPIOB,CLK_5110);
			delay_ms(1);
      //NOKIA5110_CLK=1;
      //NOKIA5110_CLK=0;
   }
...
void NOKIA5110_Init(void)
{
   setup_nokia();
	...
	delay_ms(20);
   //NOKIA5110_RST=0; 
	GPIO_ResetBits(GPIOB,RST_5110);
   delay_ms(20);
   //NOKIA5110_RST=1;
  GPIO_SetBits(GPIOB,RST_5110); 
	delay_ms(20);
   //NOKIA5110_SCE=0;
  GPIO_ResetBits(GPIOB,CE_5110); 
