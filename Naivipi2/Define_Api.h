...
#define TIMERON 1
#define TIMEROFF 0
#define MainStateTimer 20
#define MainNewTimer 21
#define MainoldTimer  22
#define STOPCOMMAND 0
#define NEWCOMMAND 1
#define RESENDCOMMAND 2
