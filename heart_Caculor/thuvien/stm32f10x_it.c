/**
  ******************************************************************************
  * @file    	LCD/LCD_16x2/stm32f10x_it.c 
...
extern ADCConvertedValue;
extern uint8_t  mang_dothi[600];
extern uint32_t	bodemxav;
extern uint32_t	bodemxaz;
extern uint32_t	bodemxak;
void xoa_eraxer(void){
}
...
{ int ca;
	//bodemxak++;
	ca=bodemxav/100;
	if((bodemxav%100)==0){ mang_dothi[ca]=ADCConvertedValue/0x20; bodemxaz=1; }
	if(bodemxav>29999) bodemxav=0; else bodemxav++;
if(bodemxak>240000) bodemxak=0; else bodemxak++;
}
